...
import br.com.sigvet.api.application.gatewayImpl.VacinaGateway;
import br.com.sigvet.api.application.mapper.vacina.VacinaDTOMapper;
import br.com.sigvet.api.application.usecaseImpl.vacina.AtualizarVacinaUseCase;
import br.com.sigvet.api.application.usecaseImpl.vacina.CadastrarVacinaUseCase;
import br.com.sigvet.api.application.usecaseImpl.vacina.DeletarVacinaUseCase;
import br.com.sigvet.api.application.usecaseImpl.vacina.ListarVacinasUseCase;
import br.com.sigvet.api.application.usecaseImpl.vacina.ObterVacinaPorIdUseCase;
